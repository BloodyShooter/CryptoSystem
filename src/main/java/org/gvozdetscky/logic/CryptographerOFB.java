...
import org.gvozdetscky.logic.utils.Transfer;
...
public class CryptographerOFB {
    ...
    private void encryptInParts(String pathFile, String password) throws FileNotFoundException {
        ...
        nameFile = pathFile + ".enc";

        try (FileOutputStream writer = new FileOutputStream(nameFile);
    ...
    private void decryptInParts(String pathFile, String password) throws FileNotFoundException {
